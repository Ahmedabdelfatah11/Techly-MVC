...
namespace Techly.DAL.Migrations
{
    ...
    [Migration("20250915235340_addOrderHeaderAndDetailsToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Techly.DAL.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Techly.DAL.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Techly.DAL.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Techly.DAL.Models.OrderDetail", b =>
                {
                    b.HasOne("Techly.DAL.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Techly.DAL.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Techly.DAL.Models.OrderHeader", b =>
                {
                    b.HasOne("Techly.DAL.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
